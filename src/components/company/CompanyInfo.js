    ...
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
      ...
      <div className="space-y-4 text-sm">
        <div className="flex items-start gap-3">
          ...
          <span className="bg-[#e6f4ff] text-[#0796fe] font-bold px-2.5 py-1 rounded-md text-xs tracking-wide">
            {company.companyType}
          </span>
        </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <a
            ...
            className="text-[#0796fe] hover:underline font-medium break-all"
          >
            {company.website}
          </a>
        </div>
