...
export default function CompanyHeader({ company }) {
  ...
  // 🚀 FIX: Secure API se role mangwao aur '[]' lagao taaki infinite loop na aaye
  useEffect(() => {
    ...
    fetchUserRole();
  }, []); // <-- Ye Khali array lagana bahut zaroori tha!
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border-l-8 border-[#092a49] p-6 sm:p-8 mb-6 relative overflow-hidden">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 relative z-10">
        ...
        {/* NAYA: Edit button sirf Admin aur Superadmin ko dikhega */}
