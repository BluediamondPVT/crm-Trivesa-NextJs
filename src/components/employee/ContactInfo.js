export default function ContactInfo({ employee }) {
  return (
      ...
      <div className="space-y-6 flex-1">
        <div className="flex items-start gap-4">
          <div className="p-2 bg-blue-50 text-blue-600 rounded-lg shrink-0">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5"><path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 0 0 2.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-2.896-1.596-5.48-3.903-7.161-6.911l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 0 0-1.091-.852H4.5A2.25 2.25 0 0 0 2.25 4.5v2.25Z" /></svg>
          </div>
          <div><p className="text-xs text-gray-500 font-semibold">Phone Number</p><p className="font-bold text-gray-800">{employee.phone}</p></div>
        </div>
        <div className="flex items-start gap-4">
          <div className="p-2 bg-blue-50 text-blue-600 rounded-lg shrink-0">
          ...
          <div><p className="text-xs text-gray-500 font-semibold">Email Address</p><p className="font-bold text-gray-800 break-all">{employee.email || "N/A"}</p></div>
        </div>
        <div className="flex items-start gap-4">
          <div className="p-2 bg-blue-50 text-blue-600 rounded-lg shrink-0">
          ...
          <div><p className="text-xs text-gray-500 font-semibold">Location / Address</p><p className="font-bold text-gray-800 leading-snug">{employee.address || "N/A"}</p></div>
        </div>
        <div className="flex items-start gap-4">
          <div className="p-2 bg-blue-50 text-blue-600 rounded-lg shrink-0">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5"><path strokeLinecap="round" strokeLinejoin="round" d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z" /></svg>
          </div>
          <div><p className="text-xs text-gray-500 font-semibold">Age</p><p className="font-bold text-gray-800 leading-snug">{employee.age ? `${employee.age} Years` : "N/A"}</p></div>
        </div>
      </div>
    </div>
  );
