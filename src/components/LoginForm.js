...
export default function LoginForm() {
  ...
  useEffect(() => {
    ...
    if (token && role) {
      const redirectPath = role === 'superadmin' ? '/dashboard/super' : '/dashboard/admin';
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#f8f6f4] p-4">
      <div className="w-full max-w-[420px]">
        <div className="bg-white rounded-xl shadow-xl overflow-hidden border-l-[8px] border-[#0796fe]">
          ...
          <div className="pt-10 pb-6 px-8 flex flex-col items-center text-center">
            <div className="w-16 h-16 bg-[#e6f4ff] rounded-full flex items-center justify-center mb-5">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8 text-[#0796fe]">
                <path fillRule="evenodd" d="M7.5 6a4.5 4.5 0 1 1 9 0 4.5 4.5 0 0 1-9 0ZM3.751 20.105a8.25 8.25 0 0 1 16.498 0 .75.75 0 0 1-.437.695A18.683 18.683 0 0 1 12 22.5c-2.786 0-5.433-.608-7.812-1.7a.75.75 0 0 1-.437-.695Z" clipRule="evenodd" />
              </svg>
            </div>
            <h1 className="text-2xl font-bold text-gray-900 mb-2">Welcome Back</h1>
            <p className="text-sm text-gray-500">Please sign in to your admin dashboard</p>
          </div>
          ...
          <div className="bg-gray-50 border-t border-gray-100 px-8 py-5 text-center">
            ...
            <div className="flex justify-center gap-4 text-[11px] text-gray-500">
              <span><strong>Admin:</strong> admin@trivesa.com</span>
              <span className="text-gray-300">|</span>
              <span><strong>Super:</strong> superadmin@trivesa.com</span>
            </div>
          </div>
