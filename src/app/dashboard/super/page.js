        ...
        <div className="flex-1 overflow-y-auto">
          <div className="max-w-6xl mx-auto p-4 sm:p-8 md:p-10">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-10 gap-4 mt-2 sm:mt-0">
              <div>
                <h1 className="text-3xl font-bold text-[#092a49]">Super Admin Dashboard</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
              ...
              <div className="bg-white rounded-2xl shadow-sm border-l-[6px] border-blue-500 p-6 flex justify-between items-center">
                <div>
                  <p className="text-xs font-bold text-gray-400 tracking-wider mb-2 uppercase">Total Admins</p>
                  <h3 className="text-4xl font-bold text-gray-800">5</h3>
                </div>
                <div className="w-12 h-12 rounded-full bg-blue-50 flex items-center justify-center text-blue-600">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6"><path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72v-3.5a3 3 0 0 0-3-3h-.15M9 6a3 3 0 1 0 0 6 3 3 0 0 0 0-6zM9 12a6 6 0 0 0-6 6v.75a3.75 3.75 0 0 0 3.75 3.75h4.5a3.75 3.75 0 0 0 3.75-3.75V18a6 6 0 0 0-6-6z" /></svg>
                </div>
              </div>
              ...
              <div className="bg-white rounded-2xl shadow-sm border-l-[6px] border-green-500 p-6 flex justify-between items-center">
                <div>
                  <p className="text-xs font-bold text-gray-400 tracking-wider mb-2 uppercase">Total Employees</p>
                  <h3 className="text-4xl font-bold text-gray-800">150</h3>
                </div>
                <div className="w-12 h-12 rounded-full bg-green-50 flex items-center justify-center text-green-600">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6"><path strokeLinecap="round" strokeLinejoin="round" d="M15 19.128a9.38 9.38 0 0 0 2.625.372 9.337 9.337 0 0 0 7.121-3.46m-9.746 6.216a9.375 9.375 0 0 1-12.561-3.83m19.19-13.196a9.375 9.375 0 0 1-9.191 16.506 9.375 9.375 0 0 1-6.319-15.066" /></svg>
                </div>
              </div>
              ...
              <div className="bg-white rounded-2xl shadow-sm border-l-[6px] border-purple-500 p-6 flex justify-between items-center">
                <div>
                  <p className="text-xs font-bold text-gray-400 tracking-wider mb-2 uppercase">Active Projects</p>
            ...
            <div className="bg-white rounded-2xl shadow-sm p-8">
              <h2 className="text-2xl font-bold text-[#092a49] mb-6">Super Admin Privileges</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-green-100 flex items-center justify-center flex-shrink-0 mt-1">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={3} stroke="currentColor" className="w-4 h-4 text-green-600"><path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" /></svg>
                    </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <span className="text-gray-700">Full Employee Management</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-green-100 flex items-center justify-center flex-shrink-0 mt-1">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={3} stroke="currentColor" className="w-4 h-4 text-green-600"><path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" /></svg>
                    </div>
                    <span className="text-gray-700">System Configuration & Settings</span>
                  </div>
                </div>
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <span className="text-gray-700">Audit Logs & Activity Tracking</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full bg-green-100 flex items-center justify-center flex-shrink-0 mt-1">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={3} stroke="currentColor" className="w-4 h-4 text-green-600"><path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" /></svg>
                    </div>
                    <span className="text-gray-700">User Roles & Permissions</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8 p-4 bg-purple-50 border border-purple-200 rounded-2xl">
              <p className="text-purple-800">
                <strong>👑 Full System Access:</strong> You are logged in as <strong>{user?.email}</strong> with complete administrative control.
              </p>
            </div>
