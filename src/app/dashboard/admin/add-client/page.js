...
export default function AddClientPage() {
  ...
  // 1. STATE UPDATE: yahan natureOfBusiness add kiya hai
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            {/* NAYA CODE: Conditional Dropdown for Nature of Business */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                type="text"
                name="commercials"
                value={formData.payoutDetails.commercials}
                onChange={(e) => handleChange(e, "payout")}
                className="w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 outline-none"
                placeholder="e.g. 8.33% of CTC"
              />
            </div>
            <div>
              <label className="block text-sm font-semibold text-gray-700 mb-1">
